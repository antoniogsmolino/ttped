  ...
  for (const p of Object.values(products)) {
    ...
    scored.push({
      ...
      trend: {
        ...
        spark: p.history.slice(-12).map((h) => h.soldDaily || 0), // solo valori (la UI non usa le date)
      },
    });
  }
